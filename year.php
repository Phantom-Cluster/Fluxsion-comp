...
//fetch query
$a=mysqli_query($con,"select * from audio where artist='$_REQUEST[artist]'");

//artist fetch
$sq="select * from artist ORDER BY artist";
$q= mysqli_query($con, $sq);
$sq1="select * from artist where artist= '$_REQUEST[artist]'";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3 col-sm-2 col-md-1 col-md-offset-3 dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            ?>
                                            <li><a href="year.php?year=<?php echo $f['year']?>"><?php echo $f['year']; ?></a></li>
                                            <?php
                                             }
                                             ?>
                                        </ul>
